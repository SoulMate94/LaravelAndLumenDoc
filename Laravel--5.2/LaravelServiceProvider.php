...
编写服务提供者#
//所有的服务提供者都继承了 Illuminate\Support\ServiceProvider 类

//这个抽象类要求你在你的提供者上定义至少一个方法：register。在 register 方法中，你应该 只将事物绑定至 服务容器 之中。永远不要试图在 register 方法中注册任何事件侦听器、路由或任何其它功能。
...
//这个文件包含了一个 providers 数组，你可以在其中列出你所有服务提供者的名称
//此数组默认会列出一组 Laravel 的核心服务提供者。这些提供者启动了 Laravel 的核心组件，例如邮件寄送者、队列、缓存及其它等等
将你的提供者加入此数组来注册服务提供者：
'providers' => [
    // 其它的服务提供者
