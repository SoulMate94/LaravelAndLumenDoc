...
切换语言#
//网站的默认语言保存在 config/app.php 配置文件
//你可以在任何时候使用 App facade 的 setLocale 方法动态地更改现有语言：
...
基本用法#
//你可以使用 trans 辅助函数来获取语言字符串，trans 函数的第一个参数接受文件名和键值名称，
//例如，从 resources/lang/messages.php 语言包获取名称为 welcome 的句子：
...
复数#
//数是个复杂的问题，不同语言对于复数有不同的规则，使用 「竖杆」 字符，可以区分单复数字符串格式
